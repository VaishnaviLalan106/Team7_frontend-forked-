...
import { TrendingUp, AlertTriangle, XCircle, Lightbulb } from 'lucide-react';
    ...
    const displayColumns = [
        {
            ...
            color: '#10b981',
            data: hasAnalyzed
                ? (personalGaps?.matched?.map(s => ({ name: s, level: 85 })) || skillGaps.strong)
                : []
        },
        {
            ...
            color: '#f59e0b',
            data: hasAnalyzed
                ? (personalGaps?.priority?.map(s => ({ name: s, level: 65 })) || skillGaps.moderate)
                : []
        },
        {
                    ...
                    {hasAnalyzed ? (
                        <>
                            ...
                            <div style={{ gridColumn: '1 / -1', marginTop: 12, display: 'flex', justifyContent: 'center' }}>
                                <a href="/roadmap" className="btn-primary" style={{ padding: '10px 24px', fontSize: 14, textDecoration: 'none', background: 'rgba(245,158,11,0.15)', color: '#f59e0b', border: '1px solid rgba(245,158,11,0.2)' }}>
                        ...
                        <div style={{ gridColumn: '1 / -1', padding: '20px 0', textAlign: 'center' }}>
                            <p style={{ fontSize: 13, color: '#64748b', margin: 0 }}>Analyze your resume to generate a personalized roadmap</p>
                        </div>
                    )}
                </div>
            </motion.div>
